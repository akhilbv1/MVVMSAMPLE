...
public class AppInjector {
    ...
    public static void inject(MVVMAPP mvvmapp) {
        */
/*DaggerApplicationComponent.builder().application(mvvmapp)
                .build().inject(mvvmapp);*//*


        DaggerAppComponent.builder().application(mvvmapp).build().inject(mvvmapp);


        mvvmapp.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            @Override
